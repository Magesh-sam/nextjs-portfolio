    ...
    >
      <div className="min-h-[200px] min-w-[300px] overflow-hidden">
        <Image
          ...
          width={300}
          height={200}
          className="filter-blur h-[200px] w-[300px] rounded-md object-contain transition duration-300 ease-in hover:scale-110"
        />
      </div>
      <div className=" flex-1 ">
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link
              className=" sliding-background relative flex h-10 w-10 items-center  justify-center  rounded-sm p-1"
              href={link}
              target="_blank"
            >
              <svg
            ...
            <Link
              className=" sliding-background relative flex h-10 w-10 items-center  justify-center rounded-md  p-1"
              href={source}
              target="_blank"
            >
              <svg
