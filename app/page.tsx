...
export default function Home() {
  return (
    <main className="flex flex-col justify-center ml-[4%] gap-[50px] pt-[10%]  max-w-screen  ">
      ...
      <section className="flex gap-[50px] items-center" aria-label="Social Icons Section">
        <Link aria-label="github link" className=" socialLink hover:-translate-y-2 transition-all duration-200 ease-in" href="https://github.com/Magesh-sam">
          <Image src={Github} alt="github icon" width={50} height={50} />
        </Link>
        <Link aria-label="linkedin link" className=" socialLink hover:-translate-y-2  transition-all duration-200 ease-in" href='https://www.linkedin.com/in/mageshkannan-annathurai/'>
          <Image src={linkedin} alt="linkedin icon" width={50} height={50} />
        </Link>
        <Link aria-label='email' className=" socialLink hover:-translate-y-2  transition-all duration-200 ease-in" href='mailto:mageshkannanam@gmail.com' >
